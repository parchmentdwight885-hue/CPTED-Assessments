// @claude:framework-owned — the framework owns this shell. Customize via the
// user-owned seams it imports — see AGENTS.md "Customizing the shell"
// (lang/head/viewport/providers/nav/brand).
